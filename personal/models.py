...
class Jugadores(models.Model):
	equipo = models.ForeignKey(Equipo, related_name='equipo_jugador', on_delete=models.PROTECT, null=False, blank=False)
...
class Tecnicos(models.Model):
	...
	equipo = models.ForeignKey(Equipo, related_name='equipo_tecnico', on_delete=models.PROTECT, null=False, blank=False)
	nombre = models.CharField(max_length=100, null=False, blank=False)
	apellido = models.CharField(max_length=100, null=False, blank=False)
	fecha_nacimiento = models.DateField(max_length=30, null=False, blank=False)
